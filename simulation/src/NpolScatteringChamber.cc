...
G4double NpolScatteringChamber::insideRadius = 0.5*0.741*m;
G4double NpolScatteringChamber::insideHeight = 0.9*m;
...
// New SHMS Window using extruded solid
  ...
  innerChamberLV->SetVisAttributes(G4VisAttributes::GetInvisible());
  //chamberWallLV->SetVisAttributes(G4VisAttributes::GetInvisible());
}
