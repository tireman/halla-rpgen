...
void NpolSBSBeamline::ConstructGEpLead(){
  ...
  G4Box *lead_wall2 = new G4Box("lead_wall2", 10.16*cm/2, 39.37*inch/2, 2.4384*m/2 /*0.5*(zstop_lead_wall2 - zstart_lead_wall2)*/ ); // 18-April-2019 <-- W.T. reduced sizes to those in CAD drawing from Feb. 2019
