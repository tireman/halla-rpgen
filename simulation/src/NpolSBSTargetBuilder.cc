...
void NpolSBSTargetBuilder::Place(G4LogicalVolume *worldlog) {
  ...
  fTargType = "kLD2";//NpolSBSBeamline::TargType; // fDetCon->fTargType; W.T.
  fExpType = "kGMn"; //NpolSBSBeamline::ExpType; // fDetCon->fExpType; W.T.

  if( (fTargType == "kLH2" || fTargType == "kLD2") ){
    
	if(fExpType == "kGep"){
      BuildGEpScatCham( worldlog );
	} else if(fExpType == "kC16"){
      BuildC16ScatCham( worldlog );
	} else{
	  BuildStandardScatCham( worldlog );
	}
  } else if(fExpType == "kTDIS" || fExpType == "kNDVCS") {
...
void NpolSBSTargetBuilder::BuildStandardCryoTarget(G4LogicalVolume *motherlog, 
  ...
  G4LogicalVolume *TargetMother_log = new G4LogicalVolume( TargetMother_solid, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "TargetMother_log" );
  ...
  if( fTargType == "kLH2" ){
    TargetCell_log = new G4LogicalVolume( TargetCell, NpolMaterials::GetInstance()->GetMaterial("LH2"), "TargetCell_log" );
  } else {
    TargetCell_log = new G4LogicalVolume( TargetCell, NpolMaterials::GetInstance()->GetMaterial("LD2"), "TargetCell_log" );
  }
  
  G4Tubs *TargetWall = new G4Tubs("TargetWall", Rcell, Rcell + sthick, fTargLen/2.0, 0, twopi );
  
  G4LogicalVolume *TargetWall_log = new G4LogicalVolume( TargetWall, NpolMaterials::GetInstance()->GetMaterial("Al"), "TargetWall_log" );
  ...
  G4LogicalVolume *uwindow_log = new G4LogicalVolume( UpstreamWindow, NpolMaterials::GetInstance()->GetMaterial("Al"), "uwindow_log" );
  G4LogicalVolume *dwindow_log = new G4LogicalVolume( DownstreamWindow, NpolMaterials::GetInstance()->GetMaterial("Al"), "dwindow_log" );
...
void NpolSBSTargetBuilder::BuildStandardScatCham(G4LogicalVolume *worldlog ){
  ...
  logicScatChamberRightSnoutWindowFrame = 
    new G4LogicalVolume(solidRightSnoutWindowFrame, NpolMaterials::GetInstance()->GetMaterial("Al"), "SCRightSnoutWindowFrame_log");
  ...
  logicScatChamberLeftSnoutWindowFrame = 
    new G4LogicalVolume(solidLeftSnoutWindowFrame, NpolMaterials::GetInstance()->GetMaterial("Al"), "SCLeftSnoutWindowFrame_log");
...
void NpolSBSTargetBuilder::BuildGEpScatCham(G4LogicalVolume *worldlog ){
  ...
  G4LogicalVolume *EarmWindowCorner_log = new G4LogicalVolume( EarmWindowCorner, NpolMaterials::GetInstance()->GetMaterial("SSteel"), "EarmWindowCorner_log" );
  ...
  G4LogicalVolume *HarmWindowCorner_log = new G4LogicalVolume( HarmWindowCorner, NpolMaterials::GetInstance()->GetMaterial("SSteel"), "HarmWindowCorner_log" );
  ...
  G4LogicalVolume *Snout_log = new G4LogicalVolume( Snout_solid, NpolMaterials::GetInstance()->GetMaterial("SSteel"), "Snout_log" );
  ...
  G4LogicalVolume *SnoutHarmWindowCutout_log = new G4LogicalVolume( HarmWindowCutout_box, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "SnoutHarmWindowCutout_log" );
  G4LogicalVolume *SnoutEarmWindowCutout_log = new G4LogicalVolume( EarmWindowCutout_box, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "SnoutEarmWindowCutout_log" );
  ...
  G4LogicalVolume *ScatChamber_log = new G4LogicalVolume( ScatChamber_solid, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "ScatChamber_log" );
  ...
  */
  ...
  // G4LogicalVolume *Snout_pgon_log = new G4LogicalVolume( Snout_pgon, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "Snout_pgon_log" );
  ...
  G4LogicalVolume *SnoutVacuum_log = new G4LogicalVolume( SnoutTaperPgon_intersect, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "SnoutVacuum_log" );
  ...
  G4LogicalVolume *IronTube_log = new G4LogicalVolume( IronTube, NpolMaterials::GetInstance()->GetMaterial("Fe"), "IronTube_log" );
  ...
  G4LogicalVolume *HarmWindow_log = new G4LogicalVolume( HarmAlWindow_box, NpolMaterials::GetInstance()->GetMaterial("Al"), "HarmWindow_log" );
  ...
  G4LogicalVolume *HarmFlange_log = new G4LogicalVolume( HarmFlange_cut, NpolMaterials::GetInstance()->GetMaterial("Al"), "HarmFlange_log" );
  ...
  G4LogicalVolume *HarmFlangeCorner_log = new G4LogicalVolume( HarmWindowCorner, NpolMaterials::GetInstance()->GetMaterial("Al"), "HarmFlangeCorner_log" );
  ...
  G4LogicalVolume *EarmWindow_log = new G4LogicalVolume( EarmAlWindow_box, NpolMaterials::GetInstance()->GetMaterial("Al"), "EarmWindow_log" );
  ...
  G4LogicalVolume *EarmFlange_log = new G4LogicalVolume( EarmFlange_cut, NpolMaterials::GetInstance()->GetMaterial("Al"), "EarmFlange_log" );
  ...
  G4LogicalVolume *EarmFlangeCorner_log = new G4LogicalVolume( EarmWindowCorner, NpolMaterials::GetInstance()->GetMaterial("Al"), "EarmFlangeCorner_log" );
...
// It is identical except it uses the function BuildStandardCryoTarget.
void NpolSBSTargetBuilder::BuildC16ScatCham(G4LogicalVolume *worldlog ){
  ...
  G4LogicalVolume *dvcs_snout_vacuum_log = new G4LogicalVolume(dvcs_snout_vacuum, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "dvcs_snout_vacuum_log" );
  ...
  G4LogicalVolume *dvcs_snout_log = new G4LogicalVolume(dvcs_snout_cut3, NpolMaterials::GetInstance()->GetMaterial("Al"), "dvcs_snout_log");
  ...
  G4LogicalVolume *dvcs_beamleft_window_log = new G4LogicalVolume( dvcs_beamleft_window, NpolMaterials::GetInstance()->GetMaterial("Al"), "dvcs_beamleft_window_log" );
  ...
  G4LogicalVolume *dvcs_beamright_window_log = new G4LogicalVolume( dvcs_beamright_window, NpolMaterials::GetInstance()->GetMaterial("Al"), "dvcs_beamright_window_log" );
  ...
  G4LogicalVolume *scham_vacuum_log = new G4LogicalVolume( scham_vacuum, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "scham_vacuum_log" );
  G4LogicalVolume *scham_wall_log = new G4LogicalVolume( swallcut2, NpolMaterials::GetInstance()->GetMaterial("Al"), "scham_wall_log" );
  ...
  // G4LogicalVolume *extpipe_log = new G4LogicalVolume(exttube, NpolMaterials::GetInstance()->GetMaterial("Al"),"extpipe_log");
  // G4LogicalVolume *extvac_log = new G4LogicalVolume(extvactube, NpolMaterials::GetInstance()->GetMaterial("Vacuum"),"extvac_log");
  ...
  // G4LogicalVolume *sc_entry_hole_vacuum_log = new G4LogicalVolume( swall_enthole, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "sc_entry_hole_vacuum_log");
  ...
  // G4LogicalVolume *sc_exit_hole_vacuum_log = new G4LogicalVolume( swall_exthole, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "sc_exit_hole_vacuum_log" );
  ...
  // G4LogicalVolume *swall_log = new G4LogicalVolume(swall_holes, NpolMaterials::GetInstance()->GetMaterial("Al"),"scham_wall_log");
  // G4LogicalVolume *sc_hcalwin_log = new G4LogicalVolume(swall_hcalwin_cut, NpolMaterials::GetInstance()->GetMaterial("Al"),"sc_hcalwin_log");
  // G4LogicalVolume *sc_bbwin_log = new G4LogicalVolume(swall_bbwin, NpolMaterials::GetInstance()->GetMaterial("Al"),"sc_bbwin_log");
  ...
  // G4LogicalVolume* chamber_inner_log = new G4LogicalVolume(chamber_inner, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "cham_inner_log");

  // Top and bottom
  G4Tubs *sc_topbottom = new G4Tubs("scham_topbottom", 0.0, swallrad, (swallrad-swallrad_in)/2.0, 0.0*deg, 360.0*deg );
  G4LogicalVolume* sc_topbottom_log = new G4LogicalVolume(sc_topbottom, NpolMaterials::GetInstance()->GetMaterial("Al"), "scham_topbottom_log");
  ...
  G4LogicalVolume *exit_pipe_log = new G4LogicalVolume( exit_pipe_cut, NpolMaterials::GetInstance()->GetMaterial("Al"), "exit_pipe_log" );
  G4LogicalVolume *exit_vacuum_log = new G4LogicalVolume( exit_vacuum_cut, NpolMaterials::GetInstance()->GetMaterial("Vacuum"), "exit_vacuum_log" );
...
void NpolSBSTargetBuilder::BuildTDISTarget(G4LogicalVolume *worldlog){
  ...
  G4LogicalVolume* targ_tube_log = new G4LogicalVolume(targ_tube, NpolMaterials::GetInstance()->GetMaterial("Al"),"targ_tube_log");
  G4LogicalVolume* targ_cap_log = new G4LogicalVolume(targ_cap, NpolMaterials::GetInstance()->GetMaterial("Al"),"targ_cap_log");
...
void NpolSBSTargetBuilder::BuildTPC(G4LogicalVolume *motherlog, G4double z_pos){
  // oversimplistic TPC
  ...
  G4LogicalVolume* TPCmother_log = 
    new G4LogicalVolume(TPCmother_solid, NpolMaterials::GetInstance()->GetMaterial("Air"),"TPCmother_log");
  G4LogicalVolume* TPCinnerwall_log = 
    new G4LogicalVolume(TPCinnerwall_solid, NpolMaterials::GetInstance()->GetMaterial("Kapton"),"TPCinnerwall_log");
  G4LogicalVolume* TPCouterwall_log = 
    new G4LogicalVolume(TPCouterwall_solid, NpolMaterials::GetInstance()->GetMaterial("Kapton"),"TPCouterwall_log");
  G4LogicalVolume* TPCgas_log = 
    new G4LogicalVolume(TPCgas_solid, NpolMaterials::GetInstance()->GetMaterial("ref4He"),"TPCouterwall_log");
